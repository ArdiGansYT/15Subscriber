/*
* Wee asu mau apa lu kesini
* Ngedit Menu? Tanpa izin?
*izin dulu lah wa :
*0852829961460
*Scrip By ArdiGans YT
- What's New?
* New Features
*/
const {
...
const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n'
            + 'FN:AZIZAE\n'
            + 'ORG:Creator ArdiGans;\n'
            + 'TEL;type=CELL;type=VOICE;waid=62852829961460:+62 852-8299-6146\n'
            + 'END:VCARD'
...
async function starts() {
	...
	client.on('qr', () => {
		console.log(color('[','white'), color('!','red'), color(']','white'), color(' Scan Tu Ngab'))
	})
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const Cogan = ["6285282996146@s.whatsapp.net"]
			...
			mess = {
				wait: '*[ WAIT ] Sedang di proses...Loading ██████━━━]67%*',
				success: '*ꜱᴜᴋꜱᴇꜱ...*',
				error: {
